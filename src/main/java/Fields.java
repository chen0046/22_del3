...
public class Fields {
    ...
    public void makeFields() {
        GUI_Field[] fields = {
                ...
                new GUI_Street("Burgerbaren", "Burgerbaren koster 1 monet.", "Den lokale burgerbar er en favorit i lokalområdet", "Denne koster 1 monet", Color.BLUE, Color.RED),
                new GUI_Street("Pizzahuset", "Pizzahuset er kendt for deres fantastiske pizzaer!", "Burgerbarens nemesis", "Denne koster 1 monet", Color.YELLOW, Color.GREEN),
                new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK),
                new GUI_Street("Slikbutikken", "Slikbutikken med", "Skal du munkes?", "1 monet mester jakel", Color.BLUE, Color.WHITE),
                ...
                new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK),
                new GUI_Street("Skaterparken", "Pris: 2 moneter", "Dér hvor alle de seje drenge er", "2 moneter", Color.YELLOW, Color.white),
                ...
                new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK),
                new GUI_Street("Legetøjsbutikken", "Pris: 3 moneter", "Ved du hvad det bedste er?", "3 moneter", Color.YELLOW, Color.white),
                new GUI_Street("Dyrehandlen", "Pris: 3 moneter", "Er det ikke tid til at få en hund?", "3 moneter", Color.YELLOW, Color.white),
                new GUI_Jail("default", "Gå i fængsel", "Gå i fængsel", "De fængsles\nSlå to ens for at komme ud", new Color(125, 125, 125), Color.BLACK),
                new GUI_Street("Bowlinghallen", "Pris: 4 moneter", "STRIKE!", "4 moneter", Color.GREEN, Color.white),
                new GUI_Street("Zoologisk have", "Pris: 4 moneter", "Hvor du kan se alt fra isbjørne til løver", "4 moneter", Color.GREEN, Color.white),
                new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK),
