...
public class Board {
    ...
    public void setFields(Field[] fields) {
        ...
        fields[16].setTitle("Legetøjsbutik"); fields[16].setSubText("M3"); fields[16].setDescription("Det er snart din fødselsdag og du har besluttet at gå i legetøjsbutikken, for at finde noget du kan ønske dig. Legetøjsbutikken koster M at købe og leje."); fields[16].setRent(".");fields[16].setMain(Color.black); fields[16].setSecondary(new Color(255, 255, 0));
        fields[17].setTitle("Dyrehandel"); fields[17].setSubText("M3"); fields[17].setDescription("Du er endelig blevet stor nok til at få et kæledyr og i Dyrehandlen er den nogen, som kan hjælpe dig med at vælge/ finde et kæledyr. Dyrehandlen koster M3 at købe og leje."); fields[17].setRent(".");fields[17].setMain(Color.black); fields[17].setSecondary(new Color(255, 255, 0));
        fields[18].setTitle("Gå i fængsel"); fields[18].setGoToJail(true);
        fields[19].setTitle("Bowlinghal"); fields[19].setSubText("M4"); fields[19].setDescription("Det er fredag og du skal til fest i bowlinghallen, det bliver en mega sjov eftermiddag og du er vild sej til bowling. Bowlinghallen koster M4 at købe og leje."); fields[19].setRent(".");fields[19].setMain(Color.black); fields[19].setSecondary(new Color(0, 128, 43));
        fields[20].setTitle("Zoo"); fields[20].setSubText("M4"); fields[20].setDescription("Endelig kom den dag hvor du skal i zoo og se alle de fantastiske dyr og sige hej til en ged. Zoo koster M4 at købe og leje."); fields[20].setRent(".");fields[20].setMain(Color.black); fields[20].setSecondary(new Color(0, 128, 43));
