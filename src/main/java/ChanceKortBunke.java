public class ChanceKortBunke {
    ...
    public ChanceKortBunke() {
        ...
        bunke[3] = new Chancekort("GRATIS FELT! Ryk frem til et mørkegrønt eller gult felt. Hvis det er ledigt, får du det GRATIS! Ellers skal du BETALE leje til ejeren.", 4);
        ...
        bunke[9] = new Chancekort("Ryk frem til Strandpromenaden.", 10);
        bunke[10] = new Chancekort("Det er din fødselsdag! alle giver dig M1. TILLYKKE MED FØDSELSDAGEN!", 11);
        bunke[11] = new Chancekort("GRATIS FELT! Ryk frem til et pink eller mørkeblåt felt. Hvis det er ledigt, får du det GRATIS! Ellers skal du BETALE leje til ejeren.", 12);
        bunke[12] = new Chancekort("Du har lavet alle dine lektier MODTAG M2 fra banken.", 13);
        bunke[13] = new Chancekort("GRATIS FELT! Ryk frem til et rødt felt. Hvis det er ledigt, får du det GRATIS! Ellers skal du BETALE leje til ejeren.", 14);
        bunke[14] = new Chancekort("GRATIS FELT! Ryk frem til Skaterparken for at lave det perfekte grind! Hvis ingen ejer den, får du den GRATIS! Ellers skal du BETALE leje til ejeren.", 15);
        bunke[15] = new Chancekort("GRATIS FELT! Ryk frem til et lyseblåt eller rødt felt. Hvis det er ledigt, får du det GRATIS! Ellers skal du BETALE leje til ejeren.", 16);
